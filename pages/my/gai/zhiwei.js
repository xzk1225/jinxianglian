...
Page({
  ...
  reques.getdata({ data: 'content/info' }, { access_token: token,id:options.id }).then(res => {
    that.setData({
      edu: res.data.result.edu,
      advantage : res.data.result.advantage,
      work_year : res.data.result.work_year,
      industry : res.data.result.industry,
      wage : res.data.result.wage,
  ...
  formSubmit:function(e){
    ...
    reques.getdata({ data:'content/updata'},e.detail.value).then(res=>{
